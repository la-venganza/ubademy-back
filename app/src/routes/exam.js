...
router.get('/:exam_id/course/:course_id/lesson/:lesson_id/user/:user_id', async (req, res) => {
  try {
...
router.get('/:exam_id/course/:course_id/lesson/:lesson_id/solution/:exam_taken_id', async (req, res) => {
  try {
